...
function generateTeamMission(input: PastorInput): TeamMissionConfig {
  ...
  return {
    ...
    bronze_threshold: 0.3,
    silver_threshold: 0.6,
    gold_threshold: 1.0,
    bronze_reward: `Bronze Badge: You helped your team! 🥉`,
    silver_reward: `Silver Badge: Your team is amazing! 🥈`,
    gold_reward: `Gold Badge: Your team is legendary! 🏆`,
    milestone_25: `Your team is 25% of the way there! Keep going! 🚀`,
    milestone_50: `Halfway there! Your team is awesome! 💪`,
    milestone_75: `Almost done! 75% complete! The finish line is near! 🎯`,
    milestone_100: `You did it! Your team completed the challenge! 🎉`,
    team_celebration: `This week your team showed the power of ${input.virtue} by working together. Celebrate what you accomplished!`,
